...
public class P06_WordCount {
    public static void main(String[] args) {
        ...
        try (Scanner scan = new Scanner(new FileReader("src/Java_Advanced.Iterators.Resources_4_Exercise/words.txt"));
             Scanner textScanner = new Scanner(new FileReader("src/Java_Advanced.Iterators.Resources_4_Exercise/text.txt"));
             PrintWriter printWriter = new PrintWriter("src/Java_Advanced.Iterators.Resources_4_Exercise/results.txt")) {
